...
BEGIN TRY
    ...
    DECLARE @id_compania        NVARCHAR(4)     =   '4826',
            ...
            @id_documento       NVARCHAR(6)     =   '231390',
            @nombre_documento   NVARCHAR(255)   =   'ENTIDAD_PEDIDO_VTEX',
    ...
    SET
        ...
        (
            SELECT
                EntidadesDinamicas = (
                    SELECT
                        f350_consec_docto       =   t430.f430_consec_docto,
    ...
    PRINT CONCAT('Batch procesado: ', @@ROWCOUNT, ' órdenes de entidad actualizadas.');
...
BEGIN CATCH
    ...
    SET @msgFinal = CONCAT(
        N'[ENTIDAD_PEDIDO_VTEX] Error línea ', CAST(@errorLine AS NVARCHAR), N' | ',
        N'Proc: ', @errorProc, N' | ',
        N'Msg: ', @errorMsg, N' | ',
