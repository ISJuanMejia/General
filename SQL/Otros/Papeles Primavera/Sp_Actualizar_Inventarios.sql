...
GO
/****** Object:  StoredProcedure [dbo].[Sp_Actualizar_Inventarios]    Script Date: 20/05/2026 2:50:50 p. m. ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	*/
	...
	USING [Integracion-VTEX].dbo.VW_Consultar_Inventario	AS S 
		ON 
			(
