...
--->================================================================================================================<---
	...
	*/
	...
	/*
		TODO -> Configurar según el caso, validar según reglas del cliente, eliminar comentarios cuando finalice configuración
		*	Tag (etiqueta) de la orden:
		*		1	->	Tag 1
		*		2	->	Tag 2
		*		3	->	Tag 3
		*		4	->	Tag 4
	*/
	DECLARE @tag_1	VARCHAR(40)	=	'1', -- TODO -> Configurar según el caso, validar según reglas del cliente
			@tag_2	VARCHAR(40)	=	'2', -- TODO -> Configurar según el caso, validar según reglas del cliente
			@tag_3	VARCHAR(40)	=	'3', -- TODO -> Configurar según el caso, validar según reglas del cliente
			@tag_4	VARCHAR(40)	=	'4'; -- TODO -> Configurar según el caso, validar según reglas del cliente
	...
	BEGIN
		BEGIN TRY
			...
			*/
			...
			/*
				TODO
				*	EJEMPLO de validar ID CIIU con respecto a las etiquetas de la orden
			*/
			DECLARE @id_ciiu	NVARCHAR(4)	=	@id_ciiu_1;
            ...
            BEGIN
				SET @id_ciiu    =
                    CASE
                        WHEN    CHARINDEX(@tag_1, @tags)	>	0
                            THEN    @id_ciiu_1
                        WHEN    CHARINDEX(@tag_2, @tags)	>	0
                            THEN    @id_ciiu_2
                        WHEN    CHARINDEX(@tag_3, @tags)	>	0
                            THEN    @id_ciiu_3
                        WHEN    CHARINDEX(@tag_4, @tags)	>	0
                            THEN    @id_ciiu_4
                        ELSE    @id_ciiu_4
                    END;
			END
		...
		BEGIN CATCH
			...
			WHERE 
				id_orden	=	@order
				AND
				id_estado	=	1; --	*	Solo actualizar si la orden se encuentra en estado 1 para evitar modificar órdenes que ya se encuentran en estados posteriores
		END CATCH;
